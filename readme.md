# Otimização por enxame de partículas aplicado a tunning de algorítmos em Machine Learning
Projeto com objetivo de utilizar a inteligência de enxames no domínio da resolução de problemas em Machine Learning, mais especificamente no tunning de modelos. 
...
- Com N_iteracoes tendendo ao infinito ou modificando os fatores de velocidade teriamos todas as partículas do enxame convergindo quase totalmente para área de melhor acurácia.
